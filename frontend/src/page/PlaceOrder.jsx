...
function PlaceOrder() {
  ...
  const originalSubtotal = useMemo(
    () => getCartSubtotal(),
    [cartItem, getCartSubtotal]
  );
  const discountedSubtotal = useMemo(
    () => getCartSubtotalDiscounted(),
    [cartItem, getCartSubtotalDiscounted]
  );
  ...
  const inputClass =
    "w-full rounded-lg border border-gray-300 px-3 py-2 focus:ring-2 focus:ring-black/10 focus:border-black/40 outline-none bg-white";
    ...
    <div className="max-w-7xl mx-auto px-6 lg:px-12 my-8">
      ...
      {cartData.length === 0 ? (
        <div className="text-center py-16 text-gray-600">
          ...
          <Link
            to="/collection"
            className="inline-block mt-4 px-4 py-2 rounded-full bg-black text-white hover:opacity-90"
          >
            Shop now
          </Link>
        </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
                  ...
                  >
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-sm font-semibold">
                        {currency}
                        {getDiscountedUnitPrice(product) * quantity}
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="mt-4 space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  <span>Shipping</span>
                  <span>
                    {shipping > 0 ? `${currency}${shipping}` : "Free"}
                  </span>
                </div>
